...
示例：[{"shot_number":1,"scene":"界海边缘","description":"石昊猛然起身","camera":"缓慢推镜 slow dolly in","duration":2.5,"lighting":"warm golden key light","action_continue":"开场","transition":"match cut","asset_ids":[12],"prompt":"3D anime, wide shot, character_id: ShiHao, style: consistent, frame-to-frame continuity, vertical 9:16"}]`
