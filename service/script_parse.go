...
6. prompt：string，英文AI绘图提示词，须含 character_id、style: consistent、Unreal Engine 5 render、frame-to-frame continuity、vertical 9:16；
...
10. asset_ids：int[]，填写本镜头出现资产ID，无对应资产时可省略。
...
示例：[{"shot_number":1,"scene":"界海边缘","description":"界海焦土全景，石昊孤身立于废墟","camera":"缓慢推镜 slow dolly in 全景建立","duration":4.5,"lighting":"warm golden key light","action_continue":"开场","transition":"match cut","asset_ids":[12],"prompt":"3D anime, wide shot establishing, character_id: ShiHao, style: consistent, frame-to-frame continuity, vertical 9:16"},{"shot_number":2,"scene":"界海边缘","description":"石昊猛然起身","camera":"固定镜头 static","duration":3.0,"lighting":"warm golden key light","action_continue":"承接全景推进","transition":"match cut","asset_ids":[12],"prompt":"3D anime, medium close-up, character_id: ShiHao, style: consistent, vertical 9:16"}]`
