...
12. asset_ids：int[]；
13. beats：**必填 2–3 项（严禁超过 3 项）**。每项 {
    "time": float 相对本镜起点秒数，从 0 严格递增且 < duration,
    "action": string 该时段内主要画面/情绪/口型变化,
    "image_prompt": string 英文，描述该关键帧的具体画面构图（景别、角色姿态/位置、镜头角度、画面焦点）。须与 shot.prompt 风格一致但聚焦该拍点的独特构图。禁止重复 shot.prompt 全文，只写该拍点独有的画面要素。例如 shot.prompt 已写了角色全身立绘，image_prompt 只需写「close-up on ShiHao's face, blood trickling from corner of mouth, eyes narrowing」
}。须覆盖开端→（转折）→收束；每拍 action 有实质进展，禁止复制同一句空话。
...
示例：{"shots":[{"shot_number":1,"scene":"混沌虚空","description":"死寂虚空中焦黑树桩缓缓显形，金粒子升起，镜头从全景缓慢推近树桩裂纹","camera":"缓慢推镜 slow dolly in 建立全景","duration":12.0,"lighting":"cold gray ambient","action_continue":"开场","transition":"fade black","scene_link":"transition","asset_ids":[3],"beats":[{"time":0.0,"action":"虚空远景，焦黑树桩剪影立于中央，死寂压抑","image_prompt":"wide establishing shot, charred black tree stump silhouette centered in dead gray void, golden particles rising faintly, low angle, oppressive atmosphere"},{"time":6.0,"action":"镜头推近，树皮裂纹与金粒子渗出盘旋","image_prompt":"medium-close on tree stump bark cracks, golden particles spiraling upward from fissures, shallow depth of field"},{"time":11.0,"action":"近景定在树桩正面，金光微亮，氛围转折","image_prompt":"close-up tree stump front face, faint golden glow illuminating bark texture, mood shift from desolate to hopeful"}],"prompt":"3D anime, wide low-angle establishing, charred black tree stump inanimate prop, dead gray void, golden particles, no human character, Unreal Engine 5 render, frame-to-frame continuity, vertical 9:16"},{"shot_number":2,"scene":"界海边缘","description":"石昊在废墟上从悲恸站起，封印残魂，凝聚神力一击贯穿敌人","dialogue":"石昊：柳神，这一战我不会退。","camera":"环绕转推 slow orbit into medium then push","duration":16.0,"lighting":"warm golden key light","action_continue":"承接树桩金光","transition":"soft dissolve","scene_link":"transition","asset_ids":[12],"beats":[{"time":0.0,"action":"石昊跪地凝视废墟，悲恸压抑","image_prompt":"low-angle medium shot, ShiHao kneeling on ruins, head bowed in grief, warm golden light from previous shot casting long shadows"},{"time":7.5,"action":"起身封印残魂，眼神转冷，掌心聚金光","image_prompt":"medium shot, ShiHao rising to feet, eyes hardening, golden energy凝聚 in cupped palms, dynamic upward composition"},{"time":14.5,"action":"挥臂掷出能量束贯穿敌人，强光爆开站定","image_prompt":"dynamic low-angle action shot, ShiHao arm extended forward, energy beam piercing through enemy figure, explosive backlight flare"}],"prompt":"3D anime, medium shot, character_id: ShiHao, gathering golden energy, style: consistent, Unreal Engine 5 render, frame-to-frame continuity, vertical 9:16"}]}`
