...
func PromptForImageAttempt(basePrompt string, attempt int) string {
	...
	case attempt < 3:
		return basePrompt
	case attempt < 7:
		return project.SanitizeImagePromptForPolicy(basePrompt, project.SanitizeLevelLight)
	default:
		return project.SanitizeImagePromptForPolicy(basePrompt, project.SanitizeLevelStrict)
	}
}
