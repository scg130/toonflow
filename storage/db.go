...
func (db *DB) migrate() error {
	...
	INSERT OR IGNORE INTO o_artStyle (name, label, prompt) VALUES
		...
		('2D_korean_webtoon', '韩系条漫', '韩国网漫风格，清晰线稿，柔和渐变上色，人物比例修长，表情细腻。'),
		('2D_american_comic', '美漫风格', '美式漫画风格，粗线条，高对比阴影，色块鲜明，动态感强。'),
		('2D_chibi', 'Q版萌系', 'Q版可爱风格，头大身小，圆润造型，明亮配色，适合轻松喜剧。'),
		('ink_wash', '水墨淡彩', '水墨淡彩插画，留白意境，墨色层次，东方美学。'),
		('watercolor', '水彩插画', '水彩手绘风格，色彩晕染，纸纹质感，柔和透明。'),
		('pixel_art', '像素风', '复古像素艺术，8-bit或16-bit游戏美学，块状像素清晰。'),
		('sketch', '铅笔素描', '铅笔素描风格，线条排线，灰阶明暗，草稿质感。'),
		('oil_painting', '油画质感', '古典油画风格，厚涂笔触，丰富光影，色彩浓郁。'),
		('cyberpunk', '赛博朋克', '赛博朋克风格，霓虹灯光，未来都市，暗色调高对比。'),
		('steampunk', '蒸汽朋克', '蒸汽朋克风格，黄铜齿轮，维多利亚元素，复古机械美学。'),
		('dark_fantasy', '黑暗奇幻', '黑暗奇幻风格，低饱和配色，神秘氛围，哥特元素。'),
		('minimalist', '极简扁平', '极简扁平插画，几何构成，少量配色，现代设计感。'),
		('film_noir', '黑色电影', '黑色电影风格，高对比黑白或低饱和，强光影，悬疑氛围。'),
		('ghibli', '吉卜力风', '吉卜力动画风格，温暖手绘背景，自然光感，治愈系色彩。'),
		('manhua_hotblood', '国漫热血', '国漫热血风格，动态构图，高饱和色彩，线条凌厉。'),
		('3D_pixar', '皮克斯3D', '皮克斯式3D动画，卡通比例，次表面散射，温暖光影。'),
		('3D_realistic', '写实3D', '写实3D渲染，PBR材质，真实光影，电影级质感。'),
		('ukiyoe', '浮世绘', '日本浮世绘风格，平面构图，木版画线条，传统配色。'),
		('retro_hk', '港风复古', '80-90年代港风复古，胶片颗粒，霓虹招牌，怀旧色调。');
